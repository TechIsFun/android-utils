...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory
            .decodeResource(getResources(), R.drawable.seek_thumb_normal);
    ...
    protected final float lineHeight = 0.3f * thumbHalfHeight;
    protected final float padding = thumbHalfWidth;
     ...
     */
    protected Thumb evalPressedThumb(float touchX) {
        Thumb result = null;
